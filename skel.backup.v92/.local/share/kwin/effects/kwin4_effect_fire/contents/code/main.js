...
class BurnMyWindowsFireEffect {
  constructor() {
    ...
    this.shader = effect.addFragmentShader(Effect.MapTexture, 'fire.frag');
  ...
  slotWindowAdded(window) {
    ...
    if (!BurnMyWindowsFireEffect.shouldAnimateWindow(window)) {
      return;
    }
    if (!window.visible) {
      return;
